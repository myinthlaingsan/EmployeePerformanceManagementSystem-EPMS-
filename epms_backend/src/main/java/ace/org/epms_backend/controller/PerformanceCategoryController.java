...
public class PerformanceCategoryController {
    ...
    public ResponseEntity<ApiResponse<PerformanceCategoryResponse>> create(@RequestBody PerformanceCategoryRequest request) {
        return ResponseEntity.ok(ApiResponse.success(service.create(request)));
    }
 
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<PerformanceCategoryResponse>> update(@PathVariable Long id, @RequestBody PerformanceCategoryRequest request) {
