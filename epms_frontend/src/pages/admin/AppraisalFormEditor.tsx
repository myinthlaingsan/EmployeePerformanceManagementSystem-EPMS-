        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-blue-500 focus:bg-white outline-none transition min-h-[100px]"
