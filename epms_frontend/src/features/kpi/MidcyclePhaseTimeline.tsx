...
import { Calendar, Award, Clock, ArrowRight, ShieldCheck } from 'lucide-react';
...
export const MidcyclePhaseTimeline: React.FC<MidcyclePhaseTimelineProps> = ({ summary, isPrivileged, onRefetch }) => {
            ...
            <div key={phase.phaseNumber} className="flex gap-4 relative">
              ...
              <div
                style={{
                  ...
                  alignItems: 'center',
                  justify: 'center',
                  background: isActive ? '#EEF3FD' : '#FFFFFF',
                  border: `2px solid ${isActive ? '#1A56DB' : '#E4E6EC'}`,
              ...
              {/* Phase details card */}
              <div style={{ flex: 1, background: '#FAFBFF', border: '0.5px solid #F0F2F6', borderRadius: '8px', padding: '12px 16px' }} className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
